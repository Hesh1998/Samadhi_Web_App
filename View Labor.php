...
<body>
  ...
  <div id="section1" class="section1">
    <div class="container">
      <h2>Labors</h2>
      <a class="btn btn-primary" style="float:right" href="Add Labor.php">Add New Labor</a>
        ...
        <tbody>
          ...
          ?>
            ...
            <tr>
              ...
              <td><a class="btn btn-danger" href="Delete Labor.php?id=<?php echo $row['id']; ?>">Delete</a></td>
            </tr>
